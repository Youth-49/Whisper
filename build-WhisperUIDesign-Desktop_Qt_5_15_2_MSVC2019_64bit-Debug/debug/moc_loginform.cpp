...
#include <memory>
#include "../../WhisperUIDesign/loginform.h"
...
QT_MOC_LITERAL(1, 10, 14), // "onLoginSuccess"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 8), // "onSignIn"
QT_MOC_LITERAL(4, 35, 8), // "getLOGIN"
QT_MOC_LITERAL(5, 44, 7), // "user_id"
QT_MOC_LITERAL(6, 52, 8), // "password"
QT_MOC_LITERAL(7, 61, 13), // "showLoginForm"
QT_MOC_LITERAL(8, 75, 22), // "on_closeButton_clicked"
QT_MOC_LITERAL(9, 98, 22), // "on_loginButton_clicked"
QT_MOC_LITERAL(10, 121, 20) // "on_regButton_clicked"

    },
    "LoginForm\0onLoginSuccess\0\0onSignIn\0"
    "getLOGIN\0user_id\0password\0showLoginForm\0"
    "on_closeButton_clicked\0on_loginButton_clicked\0"
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onSignIn(); break;
        case 2: _t->getLOGIN((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::onLoginSuccess)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginForm::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::onSignIn)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::getLOGIN)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void LoginForm::onSignIn()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void LoginForm::getLOGIN(int _t1, QString _t2)
{
