...
#include <memory>
#include "../../WhisperUIDesign/friendbutton.h"
...
struct qt_meta_stringdata_FriendButton_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_FriendButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FriendButton_t qt_meta_stringdata_FriendButton = {
    {
QT_MOC_LITERAL(0, 0, 12) // "FriendButton"
...
QT_INIT_METAOBJECT const QMetaObject FriendButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QRadioButton::staticMetaObject>(),
    qt_meta_stringdata_FriendButton.data,
    qt_meta_data_FriendButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FriendButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FriendButton.stringdata0))
